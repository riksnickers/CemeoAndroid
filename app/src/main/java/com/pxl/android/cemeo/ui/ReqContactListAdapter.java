 ...
 */
public class ReqContactListAdapter extends SingleTypeAdapter<Contact> {
     ...
     * @param items
     */
    public ReqContactListAdapter(LayoutInflater inflater, List<Contact> items) {
     ...
     * @param inflater
     */
    public ReqContactListAdapter(LayoutInflater inflater) {
        this(inflater, null);
